...
public class KafkaConsumerService {
    ...
    private static String TOPIC111= "fr-RecommendedFarmers";

        @KafkaListener(topics = "fr-ConsumerRecommend", groupId = "group_consumer", containerFactory = "kafkaListenerContainerFactory")
    ...
    @KafkaListener(topics = "fr-FarmerRecommend", groupId = "group_farmer", containerFactory = "kafkaListenerContainerFactoryFarmer")
    ...
    @KafkaListener(topics = "fr-BookingRecommend", groupId = "booking", containerFactory = "kafkaListenerContainerFactoryBooking")
