...
public class UserResource {
    ...
    private static String TOPIC5="LandsOfFarmer";
    ...
    @KafkaListener(topics = "RcommendedLandsToConsumer", groupId = "recommended_lands", containerFactory = "kafkaListenerContainerFactoryRecommendedLandsToConsumer")
